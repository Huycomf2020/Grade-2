// Dữ liệu 36 bài học chia làm 7 Chủ đề
const curriculumData = [
    {
        ...
        lessons: [
            { id: 1, title: "Bài 1: Ôn tập các số đến 100", theory: "Cấu tạo số có 2 chữ số gồm hàng chục bên trái và hàng đơn vị bên phải. Phân tích số: 87 gồm 8 chục và 7 đơn vị, viết là 87 = 80 + 7.", practice: "Dạng 1: Viết và đọc số có 2 chữ số.\nDạng 2: Sắp xếp dãy số từ bé đến lớn.\nDạng 3: Tách số thành tổng chục và đơn vị.", game: "Trò chơi 'Tìm cà rốt cho thỏ' và 'Lắp ghép bảng 100 số'." },
            { id: 2, title: "Bài 2: Tia số. Số liền trước, số liền sau", theory: "Trên tia số, vạch đầu tiên là số 0. Số bên trái bé hơn số bên phải. Số liền trước nhỏ hơn 1 đơn vị, số liền sau lớn hơn 1 đơn vị.", practice: "Dạng 1: Điền số còn thiếu vào tia số.\nDạng 2: Tìm số liền trước, số liền sau.", game: "Trò chơi 'Móc bóng bay vào tia số'." },
            { id: 3, title: "Bài 3: Các thành phần của phép cộng, phép trừ", theory: "Phép cộng: Số hạng + Số hạng = Tổng.\nPhép trừ: Số bị trừ - Số trừ = Hiệu.", practice: "Dạng 1: Điền thành phần còn thiếu vào bảng.\nDạng 2: Đặt tính rồi tính.", game: "Trò chơi 'Ghép toa tàu mừng xuân'." },
    ...
    },
    {
        ...
        lessons: [
            { id: 7, title: "Bài 7: Phép cộng (qua 10) trong phạm vi 20", theory: "Đếm tiếp hoặc tách số để làm tròn thành 10. Ví dụ 9 + 5: Tách 5 thành 1 và 4. Ta có 9 + 1 = 10, 10 + 4 = 14.", practice: "Dạng 1: Phân tích tách số dạng 9+x, 8+x.\nDạng 2: Tính biểu thức hai phép cộng.", game: "Trò chơi 'Tìm cá cho mèo'." },
            { id: 8, title: "Bài 8: Bảng cộng (qua 10)", theory: "Học thuộc Bảng cộng qua 10 từ 9 + 2 = 11 đến 2 + 9 = 11.", practice: "Dạng 1: Tính nhẩm bảng cộng.\nDạng 2: Điền số còn thiếu.", game: "Trò chơi 'Đèn lồng may mắn'." },
            ...
            { id: 10, title: "Bài 10: Luyện tập chung", theory: "Củng cố kiến thức bảng cộng qua 10 và toán lời văn thêm bớt.", practice: "Dạng 1: Hoàn thành bảng cộng.\nDạng 2: Tính chuỗi kết hợp.", game: "Trò chơi 'Bắt vịt'." },
            { id: 11, title: "Bài 11: Phép trừ (qua 10) trong phạm vi 20", theory: "Trừ để tròn 10. Ví dụ 11 - 5: Tách 11 thành 10 và 1; 10 - 5 = 5; 5 + 1 = 6.", practice: "Dạng 1: Tính nhẩm phép trừ.\nDạng 2: Điền số vào sơ đồ.", game: "Trò chơi 'Cánh diều chao gió'." },
            ...
            { id: 13, title: "Bài 13: Bài toán về nhiều hơn, ít hơn một số đơn vị", theory: "Nhiều hơn: lấy số đã biết cộng phần nhiều hơn.\nÍt hơn: lấy số đã biết trừ phần ít hơn.", practice: "Dạng 1: Giải toán Nhiều hơn.\nDạng 2: Giải toán Ít hơn.", game: "Trò chơi 'Đội cồng chiêng Tây Nguyên'." },
    ...
    },
    {
        ...
        lessons: [
            { id: 15, title: "Bài 15: Ki-lô-gam", theory: "Ki-lô-gam là đơn vị đo khối lượng, viết tắt là kg.", practice: "Dạng 1: Đọc số cân.\nDạng 2: Tính toán có đơn vị kg.", game: "Trò chơi 'Cân thăng bằng'." },
            { id: 16, title: "Bài 16: Lít", theory: "Lít là đơn vị đo dung tích, viết tắt là l.", practice: "Dạng 1: Đọc thể tích dung dịch.\nDạng 2: Tính toán đơn vị lít.", game: "Trò chơi 'Đo nước vào xô'." },
            { id: 17, title: "Bài 17: Thực hành trải nghiệm ki-lô-gam, lít", theory: "Ước lượng và thực hành cân đồ vật, đong nước thực tế.", practice: "Dạng 1: Ước lượng khối lượng.\nDạng 2: Đong nước ca 1 lít.", game: "Trò chơi 'Bác sĩ tí hon'." },
            { id: 18, title: "Bài 18: Luyện tập chung", theory: "Ôn tập tổng hợp đo lường khối lượng kg và dung tích l.", practice: "Dạng 1: Biểu thức đơn vị đo.\nDạng 2: Toán mua bán thực tế.", game: "Trò chơi 'Cầu thăng bằng'." }
        ]
    },
    {
        id: 4,
        ...
        lessons: [
            { id: 19, title: "Bài 19: Phép cộng (có nhớ) số có 2 chữ số với số có 1 chữ số", theory: "Đặt tính thẳng cột. Cộng hàng đơn vị trước: nếu lớn hơn hoặc bằng 10 thì nhớ 1 sang hàng chục.", practice: "Dạng 1: Đặt tính dạng 35 + 7.\nDạng 2: Cộng tròn chục.", game: "Trò chơi 'Mất chữ số'." },
            { id: 20, title: "Bài 20: Phép cộng (có nhớ) số có 2 chữ số với số có 2 chữ số", theory: "Ví dụ 36 + 17: 6 + 7 = 13, viết 3 nhớ 1; 3 + 1 = 4, thêm 1 = 5, viết 5. Kết quả = 53.", practice: "Dạng 1: Đặt tính dạng 36 + 17.\nDạng 2: Tính chuỗi 3 số.", game: "Trò chơi 'Xếp lại que tính'." },
            { id: 21, title: "Bài 21: Luyện tập chung", theory: "Củng cố các dạng phép cộng có nhớ phạm vi 100.", practice: "Dạng 1: Đặt tính tổng hợp.\nDạng 2: Giải toán thực tế.", game: "Trò chơi 'Chuột túi nhảy xa'." },
            { id: 22, title: "Bài 22: Phép trừ (có nhớ) số có 2 chữ số cho số có 1 chữ số", theory: "Ví dụ 32 - 7: 12 - 7 = 5, viết 5 nhớ 1; 3 - 1 = 2, viết 2. Kết quả 25.", practice: "Dạng 1: Đặt tính dạng 64 - 8.\nDạng 2: Sơ đồ mũi tên.", game: "Trò chơi 'Mèo nấp sau cửa'." },
            { id: 23, title: "Bài 23: Phép trừ (có nhớ) số có 2 chữ số cho số có 2 chữ số", theory: "Trừ hàng đơn vị trước (mượn 1 chục nếu cần), sau đó trừ hàng chục và nhớ phần mượn.", practice: "Dạng 1: Đặt tính 42 - 15.\nDạng 2: Tìm chữ số bị che.", game: "Trò chơi 'Mèo câu cá'." },
    ...
    },
    {
        ...
        lessons: [
            { id: 25, title: "Bài 25: Điểm, đoạn thẳng, đường thẳng, đường cong", theory: "Nhận biết điểm, đoạn thẳng, đường thẳng, đường cong, ba điểm thẳng hàng.", practice: "Dạng 1: Đọc tên các điểm.\nDạng 2: Đo độ dài đoạn thẳng.", game: "Trò chơi 'Nối điểm tạo hình'." },
            { id: 26, title: "Bài 26: Đường gấp khúc. Hình tứ giác", theory: "Đường gấp khúc gồm các đoạn thẳng nối tiếp. Độ dài bằng tổng các đoạn thẳng thành phần.", practice: "Dạng 1: Tính độ dài đường gấp khúc.\nDạng 2: Đếm số hình tứ giác.", game: "Trò chơi 'Xếp que tính'." },
            { id: 27, title: "Bài 27: Thực hành gấp, cắt, ghép, xếp hình", theory: "Dùng thước kẻ vẽ đoạn thẳng. Thực hành gấp, cắt ghép hình phẳng.", practice: "Dạng 1: Vẽ đoạn thẳng 6 cm.\nDạng 2: Cắt ghép hình mẫu.", game: "Trò chơi 'Tangram sáng tạo'." },
    ...
    },
    {
        ...
        lessons: [
            { id: 29, title: "Bài 29: Ngày – giờ, giờ – phút", theory: "1 ngày = 24 giờ. 1 giờ = 60 phút. Kim ngắn chỉ giờ, kim dài chỉ phút.", practice: "Dạng 1: Xem giờ đồng hồ.\nDạng 2: Nối giờ sinh hoạt.", game: "Trò chơi 'Xoay kim đồng hồ'." },
            { id: 30, title: "Bài 30: Ngày – tháng", theory: "1 năm = 12 tháng. Xem lịch tháng xác định ngày trong tuần.", practice: "Dạng 1: Xem lịch tháng.\nDạng 2: Xác định thứ trong tuần.", game: "Trò chơi 'Đi tìm ngày vàng'." },
            { id: 31, title: "Bài 31: Thực hành xem đồng hồ, xem lịch", theory: "Lập thời gian biểu cá nhân và tính khoảng thời gian.", practice: "Dạng 1: Lập lịch sinh hoạt.\nDạng 2: Tính khoảng thời gian.", game: "Trò chơi 'Rô-bốt thời gian'." },
            { id: 32, title: "Bài 32: Luyện tập chung", theory: "Ôn tập các đại lượng thời gian: giờ, phút, ngày, tháng.", practice: "Dạng 1: Đổi đơn vị thời gian.\nDạng 2: Toán chuyến xe.", game: "Trò chơi 'Du hành thời gian'." }
        ]
    },
    {
        id: 7,
        ...
        lessons: [
            { id: 33, title: "Bài 33: Ôn tập phép cộng, phép trừ phạm vi 20, 100", theory: "Ôn tập thực hiện phép cộng, phép trừ không nhớ và có nhớ.", practice: "Dạng 1: Đặt tính rồi tính.\nDạng 2: Toán giải lời văn.", game: "Trò chơi 'Vòng quay may mắn'." },
            { id: 34, title: "Bài 34: Ôn tập hình phẳng", theory: "Ôn tập nhận diện hình phẳng, tính độ dài đường gấp khúc.", practice: "Dạng 1: Đếm hình tam giác, tứ giác.\nDạng 2: Tính đường gấp khúc.", game: "Trò chơi 'Thử tài kiến trúc sư'." },
            { id: 35, title: "Bài 35: Ôn tập đo lường", theory: "Củng cố các đơn vị đo: cm, dm, kg, l, giờ, ngày, tháng.", practice: "Dạng 1: Biểu thức đo lường.\nDạng 2: Điền đơn vị thích hợp.", game: "Trò chơi 'Kính hạm đo lường'." },
            { id: 36, title: "Bài 36: Ôn tập chung", theory: "Đề tổng hợp ôn thi kết thúc Học kì 1.", practice: "Dạng 1: Trắc nghiệm chọn đáp án.\nDạng 2: Tự luận đặt tính.", game: "Trò chơi 'Đỉnh núi Tri thức'." }
        ]
    }
];
...
function renderTopicGrid() {
    ...
    curriculumData.forEach(topic => {
        ...
        `;
        card.onclick = function() { openTopicLayer(topic.id); };
        container.appendChild(card);
    });
}

// Mở Layer 2 (Chi tiết Bài học)
